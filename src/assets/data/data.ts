...
export const data = [
  {
    ...
    images: ['src/assets/imagens/app-de-receitas/login.png', 'src/assets/imagens/app-de-receitas/home.png', 'src/assets/imagens/app-de-receitas/meals.png', 'src/assets/imagens/app-de-receitas/search.png', 'src/assets/imagens/app-de-receitas/prepa.png', 'src/assets/imagens/app-de-receitas/profile.png', 'src/assets/imagens/app-de-receitas/done.png'],
  ...
  },
  {
    ...
    images: ['src/assets/imagens/ichoveu/search.png', 'src/assets/imagens/ichoveu/more.png'],
  },
  {
    id: 'StarWars Planets',
    location: 'https://github.com/netoelix/project-starwars-planets',
    images: ['src/assets/imagens/starwars/home.png', 'src/assets/imagens/starwars/list.png', 'src/assets/imagens/starwars/filter.png'],
  },
];
